...
function buildCss(T) { return `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .hero-grid{display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr 1fr;gap:24px;max-width:1200px;margin:0 auto;padding:32px 24px;padding-top:8px;min-height:calc(100vh - 220px)}
  ...
  @media(max-width:768px){
    ...
    .hero-grid{grid-template-columns:1fr;grid-template-rows:auto;padding:24px 16px;padding-top:6px;min-height:auto}
